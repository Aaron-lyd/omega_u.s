function [SP_ntp1, t_ntp1, p_ntp1,...
          SP_ntp2, t_ntp2, p_ntp2,...
          SP_ntp3, t_ntp3, p_ntp3,...
          SP_ntp4, t_ntp4, p_ntp4,...
          SP_ntp, t_ntp, p_ntp, T_ntp] = eos80_gamma_n_stp(SP,t,p,long,lat)
...
pr = zeros(size(SP));
T_ntp = eos80_legacy_pt(SP_ntp, t_ntp, p_ntp, pr);

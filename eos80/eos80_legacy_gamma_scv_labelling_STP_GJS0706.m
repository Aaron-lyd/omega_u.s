function [gamma_n, gamma_error_lower, gamma_error_upper, SP_ntp, T_ntp, p_ntp] = eos80_legacy_gamma_scv_labelling_STP_GJS0706(SP,t,p,long,lat)
...
%if false % GJS TURNS OFF EXTRAPOLATION
if any(isnan(gamma_ntp1))

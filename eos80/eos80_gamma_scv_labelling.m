function [gamma_n, gamma_error_lower, gamma_error_upper, SP_ntp, T_ntp, P_ntp] = eos80_gamma_scv_labelling(SP,t,p,long,lat)
...
% Iz1(p_ntp1 == p_ref(nz)) = nz; orignial code 
% Iz2(p_ntp2 == p_ref(nz)) = nz; orignial code 
% Iz3(p_ntp3 == p_ref(nz)) = nz; orignial code 
% Iz4(p_ntp4 == p_ref(nz)) = nz; orignial code 

Iz1(p_ntp1 == p_ref(nz)) = nz-1; % 08/04/19 new
Iz2(p_ntp2 == p_ref(nz)) = nz-1; % 08/04/19 new
Iz3(p_ntp3 == p_ref(nz)) = nz-1; % 08/04/19 new
Iz4(p_ntp4 == p_ref(nz)) = nz-1; % 08/04/19 new

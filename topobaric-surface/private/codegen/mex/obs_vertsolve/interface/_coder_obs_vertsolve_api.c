 ...
 *
 * _coder_obs_vertsolve_api.c
 *
 * Code generation for function '_coder_obs_vertsolve_api'
 *
 */
...
static void g_emlrt_marshallIn(const mxArray *dfnb, const char_T *identifier,
...
static void i_emlrt_marshallIn(const mxArray *dfnc, const char_T *identifier,
                               real_T **y_data, int32_T y_size[2]);
...
static real_T k_emlrt_marshallIn(const mxArray *s0, const char_T *identifier);
                               ...
                               real_T **y_data, int32_T y_size[2])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  h_emlrt_marshallIn(emlrtAlias(dfnb), &thisId, y_data, y_size);
  emlrtDestroyArray(&dfnb);
}
                               ...
                               real_T **y_data, int32_T y_size[2])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  j_emlrt_marshallIn(emlrtAlias(dfnc), &thisId, y_data, y_size);
  emlrtDestroyArray(&dfnc);
}
...
static real_T k_emlrt_marshallIn(const mxArray *s0, const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = l_emlrt_marshallIn(emlrtAlias(s0), &thisId);
...
static void q_emlrt_marshallIn(const mxArray *src,
                               ...
                               real_T **ret_data, int32_T ret_size[2])
{
  static const int32_T dims[2] = {64, 8};
  int32_T iv[2];
  const boolean_T bv[2] = {true, true};
  emlrtCheckVsBuiltInR2012b(emlrtRootTLSGlobal, msgId, src,
                            (const char_T *)"double", false, 2U,
...
void obs_vertsolve_api(const mxArray *const prhs[12], int32_T nlhs,
                       const mxArray *plhs[3])
{
  ...
  g_emlrt_marshallIn(emlrtAlias(prhs[7]), "dfnb", (real_T **)&dfnb_data,
                     dfnb_size);
  i_emlrt_marshallIn(emlrtAlias(prhs[8]), "dfnc", (real_T **)&dfnc_data,
                     dfnc_size);
  s0 = k_emlrt_marshallIn(emlrtAliasP(prhs[9]), "s0");
  t0 = k_emlrt_marshallIn(emlrtAliasP(prhs[10]), "t0");
  tolp = k_emlrt_marshallIn(emlrtAliasP(prhs[11]), "tolp");
  /* Invoke the target function */
  obs_vertsolve(Sppc, Tppc, P, BotK, s, t, p, *dfnb_data, dfnb_size, *dfnc_data,
                dfnc_size, s0, t0, tolp);
...
/* End of code generation (_coder_obs_vertsolve_api.c) */

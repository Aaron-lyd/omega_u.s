function sol = nonzero_mean_brent_quadprog(mat, rhs, mr, pinval)
...
% least square solution of the quadratic fucntion
% `1/2 sol' * mat * sol + b' * sol` subject to `sum(sol) = c`.

% Figure out what mean value will give Phi = 0 at ref cast, by Brent's
% method with quadprog
...
[sol, ~, ~, flag] = quadprog(mat, rhs, [], [], Aeq, c, [], [], [], opts);

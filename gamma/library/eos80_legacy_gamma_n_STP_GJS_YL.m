function [gamma_n, SP_ntp, t_ntp, T_ntp, p_ntp,...
          ...
          SP_ntp3, t_ntp3, T_ntp3, p_ntp3, SP_ntp4, t_ntp4, T_ntp4, p_ntp4] = eos80_legacy_gamma_n_STP_GJS_YL(SP,t,p,long,lat)
...
if nargout > 1
    ...
    [gamma_n(Iocean), SP_ntp(Iocean), t_ntp(Iocean), T_ntp(Iocean), p_ntp(Iocean),...
        ...
        eos80_legacy_gamma_n_labelling_STP_GJS_YL(SP(Iocean),t(Iocean),p(Iocean),long(Iocean),lat(Iocean));
else
    [gamma_n(Iocean), SP_ntp(Iocean), t_ntp(Iocean), T_ntp(Iocean), p_ntp(Iocean),...
          gamma_ntp1(Iocean), gamma_ntp2(Iocean), gamma_ntp3(Iocean), gamma_ntp4(Iocean),...
          SP_ntp1(Iocean), t_ntp1(Iocean), T_ntp1(Iocean), p_ntp1(Iocean), SP_ntp2(Iocean), t_ntp2(Iocean), T_ntp2(Iocean), p_ntp2(Iocean),...

function [gamma_n, gamma_error_lower, gamma_error_upper] = eos80_legacy_gamma_n_labelling_observe(SP,t,p,long,lat)
...
[SP_ntp1, t_ntp1, p_ntp1] = eos80_legacy_obs_bottle_to_cast(SP(:).',t(:).',p(:).',SP_ref(:,I1),t_ref(:,I1),p_ref1_dummy);
[SP_ntp2, t_ntp2, p_ntp2] = eos80_legacy_obs_bottle_to_cast(SP(:).',t(:).',p(:).',SP_ref(:,I2),t_ref(:,I2),p_ref2_dummy);
[SP_ntp3, t_ntp3, p_ntp3] = eos80_legacy_obs_bottle_to_cast(SP(:).',t(:).',p(:).',SP_ref(:,I3),t_ref(:,I3),p_ref3_dummy);
[SP_ntp4, t_ntp4, p_ntp4] = eos80_legacy_obs_bottle_to_cast(SP(:).',t(:).',p(:).',SP_ref(:,I4),t_ref(:,I4),p_ref4_dummy);
...
if any(isnan(gamma_ntp1))
    ...
    [gamma_ntp1(Inan),extrap_weights(1,Inan)] = ...
        eos80_legacy_gamma_n_labelling_extrapolation_observe(SP(Inan),t(Inan),p(Inan),...
